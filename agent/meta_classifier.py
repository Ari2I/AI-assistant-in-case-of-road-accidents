...
_KEYWORD_OVERRIDES: list[tuple[list[str], str, int]] = [
    # Общие вопросы — высокий приоритет (проверяются первыми)
    (
        ...
        "general_questions",
        -1,  # block=-1 означает общий вопрос, не этап алгоритма
    ),
    (
...
def meta_classify(
    ...
    try:
        ...
        # Если LLM вернула блок -1 или общий вопрос распознан — это general_questions
